...
export const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  const menuItems = useMemo(() => {
    ...
    const allItems = [
        ...
        { id: 'reports', label: 'रिपोर्ट (Reports)', icon: <BarChart3 size={20} />, subItems: [
            { id: 'report_rabies', label: 'रेबिज रिपोर्ट', icon: <Syringe size={16} /> },
            { id: 'report_inventory_monthly', label: 'मासिक प्रतिवेदन', icon: <PieChart size={16} /> }
        ] },
  ...
  const renderContent = () => {
    switch (activeItem) {
      ...
      case 'report_inventory_monthly': return <InventoryMonthlyReport currentFiscalYear={currentFiscalYear} currentUser={currentUser} inventoryItems={inventoryItems} stores={stores} magForms={magForms} onSaveMagForm={onSaveMagForm} generalSettings={generalSettings} issueReports={issueReports} dakhilaReports={dakhilaReports} returnEntries={returnEntries} stockEntryRequests={stockEntryRequests} />;
